...
import oracle.weblogic.migration.archive.AddCommand;
...
public class WLSMigrationArchiveHelper {
    public static final String LOGGER_NAME = "wlsdeploy.tool.archive-helper";
    private static final String CLASS = WLSMigrationArchiveHelper.class.getName();
    ...
    static int executeCommand(PrintWriter out, PrintWriter err, String... args) {
        CommandLine cmd = new CommandLine(WLSMigrationArchiveHelper.class)
