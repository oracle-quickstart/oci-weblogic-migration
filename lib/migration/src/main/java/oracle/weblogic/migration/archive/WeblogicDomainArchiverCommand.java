...
import oracle.weblogic.deploy.tool.archive_helper.add.AddTypeCommandBase;
...
public class WeblogicDomainArchiverCommand extends AddTypeCommandBase {
    private static final String CLASS = oracle.weblogic.deploy.tool.archive_helper.add.AddCustomCommand.class.getName();
