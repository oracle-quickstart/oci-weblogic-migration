...
#    }
  ...
  nsgs = {
    ...
    wlsservers  = { create = var.create_nsgs ? "always" : "never" }
    adminserver  = { create = var.create_nsgs ? "always" : "never" }
  }
...
#  control_plane_is_public      = var.control_plane_is_public
  ...
  # Domain Extras
  create_domain          = false  #false
  preferred_load_balancer = lower(var.preferred_load_balancer)
#  create_operator         = false  #false, future release
