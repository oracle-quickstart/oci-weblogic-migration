...
variable "wls_ms_ports" {
  type=list(number)
  description = "Managed Server port list"
}
...
variable "wls_machines" {
  type        = any
  description = "Machines discovered."
}

variable "wls_ms_server_details" {
  type        = any
  ...
  description = "Managed Servers details in the domain to be migrated."
}
