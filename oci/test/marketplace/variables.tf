...
variable "mp_instance_boot_volume_size_in_gbs" {
  default     = "50"
...
variable "mp_instance_count" {
  default     = 1
  description = "Number of CPE(s) to be created. Default is 1."

  validation {
    condition     = var.mp_instance_count == 1
...
variable "existent_test_subnet_ocid" {
  default     = ""
