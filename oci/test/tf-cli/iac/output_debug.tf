...
output "joi_image_id" {
  value = module.wlsservers[*].image_id
}

output "joi_module_image_id" {
  value = var.wlsserver_image_id
}

output "joi_allow_adminserver_internet_access" {
  value = var.allow_adminserver_internet_access
}

output "joi_allow_weblogic_internet_access" {
  value = var.allow_wlsservers_internet_access
}

output "joi_allow_adminserver_ssh_access" {
  value = var.allow_adminserver_ssh_access
}

output "joi_allow_weblogic_ssh_access" {
  value = var.allow_wlsservers_ssh_access
}