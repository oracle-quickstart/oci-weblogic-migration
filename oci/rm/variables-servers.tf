...
variable "wlsserver_image_type" {
  ...
  validation {
    condition     = contains(["Oracle WebLogic Server Enterprise Edition UCM Image", "Oracle Weblogic Server Suite UCM Image", "Oracle WebLogic Server Enterprise Edition BYOL Image", "Oracle Weblogic Server Suite BYOL Image", "custom", "platform"], var.wlsserver_image_type)
