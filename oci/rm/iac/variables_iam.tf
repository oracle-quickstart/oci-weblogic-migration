...
variable "wlsserver_compartment_id" {
  default     = null
  description = "The compartment id where wlsserver group resources will be created."
  type        = string
}
...
variable "region" {
  ...
  description = "The OCI region where Weblogic Servers resources will be created."
  type        = string
}
...
variable "create_iam_wlsserver_policy" {
  default     = "auto"
  description = "Whether to create an IAM dynamic group and policy rules for self-managed wlsserver nodes. Depends on configuration of associated components when set to 'auto'. Ignored when 'create_iam_resources' is false."
  type        = string
  validation {
    condition     = contains(["never", "auto", "always"], var.create_iam_wlsserver_policy)
    error_message = "Accepted values are never, auto, or always"
  }
}
...
variable "wlsservers_defined_tags" {
  type        = map(string)
  description = "Defined tags applied to created resources."
  default     = {}
}
variable "wlsservers_freeform_tags" {
  type        = map(string)
  description = "Freeform tags applied to created resources."
  default     = {}
}
variable "resource_manager_defined_tags" {
  type        = map(string)
  description = "Defined tags applied to created resources."
  default     = {}
}
variable "resource_manager_freeform_tags" {
  type        = map(string)
  description = "Freeform tags applied to created resources."
  default     = {}
}
