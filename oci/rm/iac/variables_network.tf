...
variable "vcn_name" {
  default     = null
  description = "Display name for the created VCN. Defaults to '$domain' value."
  type        = string
}
...
variable "allow_node_port_access" {
  default     = false
  description = "Whether to allow access from wlsservers NodePort range to load balancers."
  type        = bool
}

variable "allow_adminserver_internet_access" {
  default     = true
  description = "Allow AdminServer node to egress to internet. "
  type        = bool
}

variable "allow_wlsservers_internet_access" {
  default     = true
  description = "Allow Weblogic Managed Server nodes to egress to internet. "
  type        = bool
}


variable "allow_wlsservers_ssh_access" {
  default     = false
  description = "Whether to allow SSH access to Weblogic Managed Server nodes."
  type        = bool
}

variable "allow_adminserver_ssh_access" {
  default     = false
  description = "Whether to allow SSH access to AdminServer nodes."
  type        = bool
}

variable "allow_bastion_domain_access" {
  default     = false
  description = "Whether to allow access to the Weblogic Managed Servers from the bastion host."
  type        = bool
}
...
variable "allow_rules_wlsservers" {
  default     = {}
  description = "A map of additional rules to allow traffic for the wlsservers."
  type        = any
}

variable "allow_rules_adminserver" {
  default     = {}
  description = "A map of additional rules to allow traffic for the adminserver."
  type        = any
}
