...
locals {
  ...
  oci_db_network_compartment_id = local.db_strategy_is_oci_db ? (local.is_oci_db && var.oci_db_network_compartment_id_0 == "" ? var.oci_db_compartment_id_0 : var.oci_db_network_compartment_id_0) : ""
