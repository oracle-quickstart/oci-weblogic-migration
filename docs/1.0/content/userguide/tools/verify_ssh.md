...
With the Verify SSH Tool, you can verify that an SSH connection can be successfully established by OWM and optionally,
...
remote machine and the user's private key file, as needed.  The Verify SSH Tool (and other OWM tools that support SSH)
