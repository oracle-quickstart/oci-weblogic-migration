...
#### WebLogic policies
The model allows for the definition of additional authorization policies on WebLogic resources.  Note that OWM does not
...
- Currently, OWM does not support modifying the default WebLogic authorization policies. 