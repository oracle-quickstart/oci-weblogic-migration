...
| `Allow group Non-Admin to manage dns-family in compartment MyCompartment` | To manage DNS resources(Zones and Private views)                | Network Compartment |
...
| `Allow group Non-Admin to manage orm-private-endpoints in compartment MyCompartment` | To create Private Endpoints (required **only if "Provision Bastion Instance"** checkbox is **not** selected)                               | Network Compartment |
